...
public class ListaModalidades {
	...
	public void preencherTabela() {
		...
		String [] linhas = new String[] {"id_Modalidade","Nome","Valor"};
		ModalidadeDAO modalidadeDao = new ModalidadeDAO();
		
		try {
			for (Modalidade modalidade: modalidadeDao.getAllModalidade()) {
				
				dados.add(new Object[]{modalidade.getId_modalidade(),modalidade.getNome(),modalidade.getValor()});
			}
